...
namespace Moviz.Controllers
{
    public class MovieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImagePath,ReleaseDate")] MovieModel movieModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ImagePath,ReleaseDate")] MovieModel movieModel)
        {
            if (id != movieModel.Id)
            {
                return NotFound();
